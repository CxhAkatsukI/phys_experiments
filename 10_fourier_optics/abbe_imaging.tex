...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[height=5cm]{./pictures/photos/阿贝成像（光路图）.jpg}
    \caption{阿贝成像（光路图）}
    \label{fig:阿贝成像（光路图）}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[height=5cm]{./pictures/photos/光字（无滤波器）.jpg}
    \caption{光字（无滤波器）}
    \label{fig:光字（无滤波器）}
  \end{subfigure}
  \label{fig:combined}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[height=5cm]{./pictures/photos/单缝水平放置.jpg}
    \caption{单缝水平放置}
    \label{fig:单缝水平放置}
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[height=5cm]{./pictures/photos/光字的像充满纵纹.jpg}
    \caption{光字的像充满纵纹}
    \label{fig:光字的像充满纵纹}
  \end{subfigure}
  \label{fig:combined}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[height=5cm]{./pictures/photos/单缝旋转九十度放置.jpg}
    \caption{单缝旋转九十度放置}
    \label{fig:单缝旋转九十度放置}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[height=5cm]{./pictures/photos/光字的像充满横纹.jpg}
    \caption{光字的像充满横纹}
    \label{fig:光字的像充满横纹}
  \end{subfigure}
  \label{fig:combined}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[height=5cm]{./pictures/photos/单缝旋转四十五度放置.jpg}
    \caption{单缝旋转四十五度放置}
    \label{fig:单缝旋转四十五度放置}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[height=5cm]{./pictures/photos/光字的像呈现倾斜条纹.jpg}
    \caption{光字的像呈现倾斜条纹}
    \label{fig:光字的像呈现倾斜条纹}
  \end{subfigure}
  \label{fig:combined}
\end{figure}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[height=5cm]{./pictures/photos/只允许零级点通过孔.jpg}
    \caption{只允许零级点通过孔}
    \label{fig:只允许零级点通过孔}
  \end{subfigure}
  \hfill
  \begin{subfigure}[b]{0.45\textwidth}
    \centering
    \includegraphics[height=5cm]{./pictures/photos/光字的像没有条纹而只有轮廓.jpg}
    \caption{光字的像没有条纹而只有轮廓}
    \label{fig:光字的像没有条纹而只有轮廓}
  \end{subfigure}
  \label{fig:combined}
\end{figure}
